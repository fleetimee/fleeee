...
func NewHandlerTransaction(transaction entities.EntityTransaction) *handleTransaction {
...
func (h *handleTransaction) HandlerCreate(ctx *gin.Context) {
	var body schemes.SchemeTransaction
...
func ValidatorTransaction(ctx *gin.Context, input schemes.SchemeTransaction, Type string) (interface{}, int) {
